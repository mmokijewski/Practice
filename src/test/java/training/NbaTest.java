...
class NbaTest {
    ...
    @Test
    void showProperResults() {
        assertEquals(Nba.nbaCup(resultSheet3, "Boston Celtics"), "Boston Celtics:W=4;D=0;L=0;Scored=403;Conceded=350;Points=12");
    }

    @Test
    void noTeamNameOnList() {
        assertEquals(Nba.nbaCup(resultSheet3, "Boston Celt"), "Boston Celt:This team didn't play!");
    }

    @Test
    void emptyName() {
        assertEquals(Nba.nbaCup(resultSheet3, ""), "");
    }
